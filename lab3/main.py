...
if __name__ == "__main__":
    ...
    print("A PRIORI MODEL")
    most_frequent_rating = int(train_dataset['Rating'].value_counts().idxmax())
    a_priori_predicted_train_dataset = [most_frequent_rating] * int(train_dataset.shape[0])
    a_priori_predicted_validation_dataset = [most_frequent_rating] * int(validation_dataset.shape[0])
    a_priori_predicted_test_dataset = [most_frequent_rating] * int(test_dataset.shape[0])

    print("BELL DATA")
    print("READING DATA")
    bell_dataset = pd.read_csv('bell_data.csv', delimiter=",", engine='python')
    bell_dataset = bell_dataset.dropna(axis=0, how='any')
    bell_x = bell_dataset.drop(columns=['Rating'])
    bell_y = bell_dataset['Rating']

    print("PREDICT TO BELL TEST SET")
    predicted_bell = predict(decision_tree, bell_x)
    a_priori_predicted_bell = [most_frequent_rating] * int(bell_dataset.shape[0])

    print("\nDECISION TREE CLASSIFICATION")

    print("train accuracy_score:")
    print(accuracy_score(train_dataset_y, predicted_train_dataset))
    print("validation accuracy_score:")
    print(accuracy_score(validation_dataset_y, predicted_validation_dataset))
    print("test accuracy_score:")
    print(accuracy_score(test_dataset_y, predicted_test_dataset))
    print("bell test accuracy_score:")
    print(accuracy_score(bell_y, predicted_bell))

    print("train confusion_matrix:")
    print(confusion_matrix(train_dataset_y, predicted_train_dataset))
    print("validation confusion_matrix:")
    print(confusion_matrix(validation_dataset_y, predicted_validation_dataset))
    print("test confusion_matrix:")
    print(confusion_matrix(test_dataset_y, predicted_test_dataset))
    print("bell test confusion_matrix:")
    print(confusion_matrix(bell_y, predicted_bell))

    print("train mean_squared_error:")
    print(mean_squared_error(train_dataset_y, predicted_train_dataset))
    print("validation mean_squared_error:")
    print(mean_squared_error(validation_dataset_y, predicted_validation_dataset))
    print("test mean_squared_error:")
    print(mean_squared_error(test_dataset_y, predicted_test_dataset))
    print("bell test mean_squared_error:")
    print(mean_squared_error(bell_y, predicted_bell))

    print("train cohen_kappa_score:")
    print(cohen_kappa_score(train_dataset_y, predicted_train_dataset))
    print("validation cohen_kappa_score:")
    print(cohen_kappa_score(validation_dataset_y, predicted_validation_dataset))
    print("test cohen_kappa_score:")
    print(cohen_kappa_score(test_dataset_y, predicted_test_dataset))
    print("bell test cohen_kappa_score:")
    print(cohen_kappa_score(bell_y, predicted_bell))

    print("\nA PRIORI CLASSIFICATION")

    print("train accuracy_score:")
    print(accuracy_score(train_dataset_y, a_priori_predicted_train_dataset))
    print("validation accuracy_score:")
    print(accuracy_score(validation_dataset_y, a_priori_predicted_validation_dataset))
    print("test accuracy_score:")
    print(accuracy_score(test_dataset_y, a_priori_predicted_test_dataset))
    print("bell test accuracy_score:")
    print(accuracy_score(bell_y, a_priori_predicted_bell))

    print("train confusion_matrix:")
    print(confusion_matrix(train_dataset_y, a_priori_predicted_train_dataset))
    print("validation confusion_matrix:")
    print(confusion_matrix(validation_dataset_y, a_priori_predicted_validation_dataset))
    print("test confusion_matrix:")
    print(confusion_matrix(test_dataset_y, a_priori_predicted_test_dataset))
    print("bell test confusion_matrix:")
    print(confusion_matrix(bell_y, a_priori_predicted_bell))

    print("train mean_squared_error:")
    print(mean_squared_error(train_dataset_y, a_priori_predicted_train_dataset))
    print("validation mean_squared_error:")
    print(mean_squared_error(validation_dataset_y, a_priori_predicted_validation_dataset))
    print("test mean_squared_error:")
    print(mean_squared_error(test_dataset_y, a_priori_predicted_test_dataset))
    print("bell test mean_squared_error:")
    print(mean_squared_error(bell_y, a_priori_predicted_bell))

    print("train cohen_kappa_score:")
    print(cohen_kappa_score(train_dataset_y, a_priori_predicted_train_dataset))
    print("validation cohen_kappa_score:")
    print(cohen_kappa_score(validation_dataset_y, a_priori_predicted_validation_dataset))
    print("test cohen_kappa_score:")
    print(cohen_kappa_score(test_dataset_y, a_priori_predicted_test_dataset))
    print("bell test cohen_kappa_score:")
    print(cohen_kappa_score(bell_y, a_priori_predicted_bell))

    print("PREDICOES PARA BELL")
    print(predicted_bell)
    print(a_priori_predicted_bell)
